...
- **Event noise.** Subscribers who care only about lifecycle changes see attribute events too. Mitigated by the derived `changes_state` flag and by subscription granularity, already open in TODO.md.
