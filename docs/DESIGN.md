...
**Status: under review.** The model is settled. Every finding of every review is recorded in [`design/defects.md`](design/defects.md), 186 entries and five cosmetics, all closed. The author has ruled on ADR-0065 to ADR-0073; ADR-0019 to ADR-0064 are written and await review.
