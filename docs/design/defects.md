...
**Open.** Either a built-in object records publishes, or a migration event's cause is the declaration version it already carries and the publish event is dropped.
