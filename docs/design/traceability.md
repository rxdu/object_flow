...
- *Unverifiable*: the PRD itself says the requirement cannot yet be verified. The checker refuses this status on any other row, so it cannot be used to park a hard one.
...
Current: 70 covered, 0 partial, 0 gaps, 1 unverifiable.
...
| F3 | DESIGN §5.8, §10; ADR-0025, ADR-0037; library-api.md §6 | covered | |
| F4 | DESIGN §5.5; ADR-0090, ADR-0092; library-api.md §4 | covered | |
| F5 | DESIGN §5.9; ADR-0027; publish-and-import.md §3 | covered | |
| F6 | DESIGN §9; ADR-0085; publish-and-import.md §1 | covered | |
| F7 | DESIGN §5.9, §9; ADR-0085, ADR-0096; publish-and-import.md §1, §2; storage-schema.md §6 | covered | |
| D1 | DESIGN §7; ADR-0013, ADR-0033; storage-schema.md §2 | covered | |
| D2 | DESIGN §6, §7; ADR-0083, ADR-0088; storage-schema.md §6 | covered | |
| D3 | DESIGN §5.11; ADR-0082; declaration-syntax.md §6.8; storage-schema.md §3; renderers.md §3 | covered | |
| D4 | DESIGN §5.11; ADR-0082, ADR-0095, ADR-0096; declaration-syntax.md §6.8; storage-schema.md §3 | covered | |
| D5 | DESIGN §5.4, §5.11; ADR-0083, ADR-0095, ADR-0096; declaration-syntax.md §4.2, §6.8; storage-schema.md §2, §6 | covered | |
...
| D8 | DESIGN §8, §5.11; ADR-0031, ADR-0078, ADR-0082, ADR-0087, ADR-0096; storage-schema.md §9 | covered | |
| D9 | DESIGN §5.11; ADR-0082; declaration-syntax.md §6.8 | covered | |
| D10 | DESIGN §5.13; ADR-0086; declaration-syntax.md §6.10; storage-schema.md §6 | covered | |
| D11 | DESIGN §5.2; ADR-0083, ADR-0086; storage-schema.md §6 | covered | |
| D12 | DESIGN §5.11; ADR-0082, ADR-0095, ADR-0096; declaration-syntax.md §6.8 | covered | |
| C1 | DESIGN §5.2, §5.12; ADR-0084; declaration-syntax.md §6.9 | covered | |
| C2 | DESIGN §5.12; ADR-0084, ADR-0096; renderers.md §2, §3; library-api.md §6 | covered | |
| C3 | DESIGN §5.12; ADR-0084; declaration-syntax.md §6.9 | covered | |
...
| M1 | DESIGN §5.12; ADR-0083, ADR-0084, ADR-0096; storage-schema.md §6 | covered | |
| M2 | DESIGN §10; ADR-0084; library-api.md §6 | covered | |
| M3 | DESIGN §5.12; ADR-0084; declaration-syntax.md §6.9; storage-schema.md §6 | covered | |
| M4 | DESIGN §5.12; ADR-0084, ADR-0096; declaration-syntax.md §6.9, §8.1 | covered | |
| M5 | DESIGN §10; ADR-0094; library-api.md §6 | covered | |
| M6 | DESIGN §5.13; ADR-0086, ADR-0096; storage-schema.md §6 | covered | |
...
| L5 | DESIGN §5.7, §5.12; ADR-0084, ADR-0092; declaration-syntax.md §6.9 | covered | |
...
| V4 | DESIGN §9; ADR-0085; publish-and-import.md §1 | covered | |
| V5 | DESIGN §5.11; ADR-0082; declaration-syntax.md §6.8; publish-and-import.md §1 | covered | |
| T1 | DESIGN §3, §13; adversarial-harness.md §1, §2 | covered | |
| T2 | DESIGN §1; adversarial-harness.md | covered | |
| T3 | DESIGN §7, §8; ADR-0033, ADR-0083, ADR-0089; storage-schema.md §2 | covered | |
| T4 | DESIGN §8, §10; ADR-0083; storage-schema.md §3.2; publish-and-import.md §4 | covered | |
| T5 | DESIGN §5.8, §5.12, §6, §10; ADR-0030, ADR-0084, ADR-0095, ADR-0096; library-api.md §6 | covered | |
| N1 | DESIGN §2; ADR-0090; storage-schema.md §7 | covered | |
| N2 | DESIGN §2; ADR-0012, ADR-0091, ADR-0096; library-api.md §1; storage-schema.md §6, §9 | covered | |
| N3 | DESIGN §2; ADR-0090; storage-schema.md §7 | covered | |
| N4 | DESIGN §13; ADR-0091; adversarial-harness.md §4 | covered | |
| N5 | DESIGN §11; ADR-0075, ADR-0077, ADR-0093, ADR-0096; publish-and-import.md §4, §7; first-consumer-cutover.md §4a | covered | |

## Use cases

| ID | Covered by | Status | What remains |
|---|---|---|---|
| UC-1 | DESIGN §5.12, §7, §11; declaration-syntax.md §6.9; publish-and-import.md §4 | covered | |
| UC-2 | DESIGN §6, §7, §5.12; ADR-0096; declaration-syntax.md §6.9; storage-schema.md §6 | covered | |
| UC-3 | DESIGN §8, §10; ADR-0096; declaration-syntax.md §6.9; publish-and-import.md §4 | covered | |
| UC-4 | DESIGN §5.11, §5.5, §6; declaration-syntax.md §6.8 | covered | |
...
| UC-8 | DESIGN §5.12; declaration-syntax.md §6.9 | covered | |
| UC-9 | DESIGN §5.12; declaration-syntax.md §6.9 | covered | |
| UC-10 | DESIGN §5.5, §5.12; ADR-0096; declaration-syntax.md §6.9; library-api.md §4 | covered | |
| UC-11 | DESIGN §10, §5.12; library-api.md §6; renderers.md §3 | covered | |
| UC-12 | DESIGN §5.12; declaration-syntax.md §8.3 | covered | |
| UC-13 | DESIGN §5.11, §5.12, §10; declaration-syntax.md §6.8, §6.9; library-api.md §6 | covered | |
| UC-14 | DESIGN §5.5; declaration-syntax.md §5.1 | covered | |
| UC-15 | DESIGN §9; publish-and-import.md §1 | covered | |
| UC-16 | DESIGN §5.1, §5.12; ADR-0096; declaration-syntax.md §6.9, §8.1 | covered | |
| UC-17 | DESIGN §8; ADR-0087, ADR-0096; storage-schema.md §9 | covered | |
| UC-18 | DESIGN §5.13, §11; ADR-0096; declaration-syntax.md §6.9, §6.10 | covered | |
| UC-19 | DESIGN §5.11, §5.4, §5.5, §13; ADR-0096; adversarial-harness.md §2 | covered | |
