...
| F5 | DESIGN §5.9; ADR-0027; publish-and-import.md §3; ADR-0099; declaration-syntax.md §6.6 | covered |  |
| F6 | DESIGN §9; ADR-0085; publish-and-import.md §1; ADR-0097 | covered |  |
| F7 | DESIGN §5.9, §9; ADR-0085, ADR-0096; publish-and-import.md §1, §2; storage-schema.md §6; ADR-0097 | covered |  |
...
| D8 | DESIGN §8, §5.11; ADR-0031, ADR-0078, ADR-0082, ADR-0087, ADR-0096; storage-schema.md §9; ADR-0100 | covered |  |
...
| M1 | DESIGN §5.12; ADR-0083, ADR-0084, ADR-0096; storage-schema.md §6; ADR-0098; declaration-syntax.md §6.11 | covered |  |
| M2 | DESIGN §10; ADR-0084; library-api.md §6; ADR-0098 | covered |  |
| M3 | DESIGN §5.12; ADR-0084; declaration-syntax.md §6.9; storage-schema.md §6; ADR-0098 | covered |  |
| M4 | DESIGN §5.12; ADR-0084, ADR-0096; declaration-syntax.md §6.9, §8.1; ADR-0098 | covered |  |
| M5 | DESIGN §10; ADR-0094; library-api.md §6 | covered | |
| M6 | DESIGN §5.13; ADR-0086, ADR-0096; storage-schema.md §6; ADR-0098; declaration-syntax.md §6.11 | covered |  |
...
| T1 | DESIGN §3, §13; adversarial-harness.md §1, §2; ADR-0097, ADR-0100 | covered |  |
| T2 | DESIGN §1; adversarial-harness.md | covered | |
| T3 | DESIGN §7, §8; ADR-0033, ADR-0083, ADR-0089; storage-schema.md §2; ADR-0099, ADR-0100 | covered |  |
| T4 | DESIGN §8, §10; ADR-0083; storage-schema.md §3.2; publish-and-import.md §4; ADR-0100 | covered |  |
| T5 | DESIGN §5.8, §5.12, §6, §10; ADR-0030, ADR-0084, ADR-0095, ADR-0096; library-api.md §6; ADR-0100 | covered |  |
...
| N5 | DESIGN §11; ADR-0075, ADR-0077, ADR-0093, ADR-0096; publish-and-import.md §4, §7; first-consumer-cutover.md §4a; ADR-0100; first-consumer-cutover.md §4a | covered |  |
...
| UC-16 | DESIGN §5.1, §5.12; ADR-0096; declaration-syntax.md §6.9, §8.1; ADR-0098 | covered |  |
| UC-17 | DESIGN §8; ADR-0087, ADR-0096; storage-schema.md §9; ADR-0100 | covered |  |
| UC-18 | DESIGN §5.13, §11; ADR-0096; declaration-syntax.md §6.9, §6.10; ADR-0098; declaration-syntax.md §6.11 | covered |  |
