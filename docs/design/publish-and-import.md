...
- **Re-running an import.** The disposition file makes a second dry run comparable to the first. Whether a partially completed import can be resumed, or must be torn down and redone, is not decided here, and it matters most for the cutover window.
