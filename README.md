...
> **Status: design only, under review.** Nothing is implemented. This repository contains the design record: the model, the declaration syntax consumers write against, the decisions taken, and a defect register whose 133 findings have been resolved but not yet reviewed by the author.
